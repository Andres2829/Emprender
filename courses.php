						...
						<table class="table table-condensed table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="">Programa Academico</th>
...
<script>
	...
	$('#new_course').click(function() {
		uni_modal("Entrada de nuevos Programas Academicos y tarifas", "manage_course.php", 'large')

	})

	$('.edit_course').click(function() {
		uni_modal("Administrar la entrada Programas Academicos y tarifas", "manage_course.php?id=" + $(this).attr('data-id'), 'large')

	})
	$('.delete_course').click(function() {
		_conf("¿Deseas eliminar este Programa Academico?", "delete_course", [$(this).attr('data-id')])
	})
