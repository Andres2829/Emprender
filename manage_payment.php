...
<div class="container-fluid">
	<form id="manage-payment">
		...
		<div class="form-group">
			...
			<input type="date" class="form-control text-right" name="date_created" value="<?php echo isset($date_created) ? $arqueo : '' ?>" required>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label for="" class="control-label">Cuotas a Cancelar</label>
			<input type="number" step="any" min="0" class="form-control text-right" name="cuotas_pagadas" value="<?php echo isset($cuotas_pagadas) ? number_format($cuotas_pagadas) : 0 ?>" required>
		</div>
		<div class="form-group">
			<label for="" class="control-label">Numero Factura</label>
			<input type="text" class="form-control text-right" name="nfactura" value="<?php echo isset($nfactura) ? $nfactura : '' ?>" required>
		</div>
		<div class="form-group">
			<label for="" class="control-label">Arqueo</label>
			<input type="text" class="form-control text-right" name="arqueo" value="<?php echo isset($arqueo) ?  $arqueo : '' ?>" required>
		</div>
		<div class="form-group">
