...
<div class="container-fluid">
    <form action="" id="manage-student">
        ...
        <div class="form-group">
            <label for="" class="control-label">Acudiente</label>
            <textarea name="acudiente" id="" cols="30" rows="3" class="form-control" required=""><?php echo isset($acudiente) ? $acudiente : '' ?></textarea>
        </div>
        <div class="form-group">
            <label for="" class="control-label">Acerca del estudiante</label>
            <textarea name="acerca" id="" cols="30" rows="3" class="form-control" required=""><?php echo isset($acerca) ? $acerca : '' ?></textarea>
        </div>
    </form>
</div>
